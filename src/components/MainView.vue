          ...
          <nav class="relative max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6" aria-label="Global">
            <div class="flex items-center flex-1">
              ...
              <div class="hidden space-x-8 md:flex md:ml-10">
                <a v-for="item in [1,2]" :key="item" class="text-base font-medium text-white hover:text-gray-300">{{ item }}</a>
              </div>
            </div>
          </nav>
        </div>
            ...
            <div class="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
              ...
              <div class="pt-5 pb-6">
                <div class="px-2 space-y-1">
                  <div class="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-50">
                      <span class="hover:underline" @click="activeFilter.maxTime = 15">15 min</span>, <span class="hover:underline" @click="activeFilter.maxTime = 30">30 min</span>, 60+ min
                  </div>
                  <div class="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-50">
                ...
                <div class="mt-6 px-5">
                  <PopoverButton class="block text-center w-full py-3 px-4 rounded-md shadow bg-indigo-600 text-white font-medium hover:bg-indigo-700">Chiudi</PopoverButton>
                </div>
              </div>
            </div>
          </PopoverPanel>
